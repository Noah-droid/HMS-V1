...
class warden(models.Model):
    ...
    Hostel_Name = models.ForeignKey(blocks, null=True, on_delete=models.SET_NULL)
    Hostel_Number = models.ForeignKey(floors, null=True, on_delete=models.SET_NULL)
...
#     numoccupied = models.ForeignKey(Number)